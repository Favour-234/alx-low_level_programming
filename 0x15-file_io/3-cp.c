...
/**
 * create_buffer - Create a buffer and allocate 1024 byte to it.
 * @file: THE name of the buffer file should be stored in the char data type.
 *
 ...
 * @fd:file descriptor which will be closed.
 */
void close_file(int fd)
{
	int c;
