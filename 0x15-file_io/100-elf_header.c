 ...
 * @e_ident: This is the same pointer to an array containing the ELF class.
 */
...
/**
 * print_data - This is a function to print the data of an ELF header.
...
/**
 * main - Display the information contained in the ELF header at the start of an ELF file.
 * @argc: The number of arguments given to the program.
 * @argv: An array of pointers to the arguments.
 *
 * Return: 0 on success.
 *
 * Description: If the file is not an ELF File or if the function fails,exit with code 98.
 */
